...
Hardware integration test последовательно открывает два разных активных WASAPI‑выхода. Для его выполнения на машине должны присутствовать как минимум два активных render endpoint.
